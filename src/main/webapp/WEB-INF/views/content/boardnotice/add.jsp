...
<!-- 
    📌 add.jsp
    - 새 글 작성
    - form → RestController(/api/boardnotice/add) 전송
-->
...
<section class="max-w-4xl mx-auto mt-10 bg-white rounded-xl shadow p-8 space-y-6">
    ...
    <form action="/pulse/api/boardnotice/add" method="post" class="space-y-5">
        ...
        <div class="flex justify-end gap-3">
            <button type="button" onclick="location.href='/pulse/boardnotice/list.do'"
