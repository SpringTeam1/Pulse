...
<section class="max-w-4xl mx-auto mt-10 bg-white rounded-xl shadow p-8 space-y-8">
  ...
  <form id="boardForm" method="POST" action="${pageContext.request.contextPath}/boardsuggestion/addok" enctype="multipart/form-data" class="space-y-6">
  
	  <!-- 제목 -->
	  <div>
	      <label for="title" class="block flex flex-column justify-between text-gray-700 font-semibold mb-4">제목
	          <div>
