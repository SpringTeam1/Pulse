...
<section class="max-w-4xl mx-auto mt-12 bg-white rounded-2xl shadow p-10 space-y-8">
    ...
    <form id="editForm"
          method="POST"
          action="${pageContext.request.contextPath}/api/v1/crew/board/${bdto.boardContentSeq}/edit"
          enctype="multipart/form-data"
          class="space-y-8">

        <input type="hidden" name="boardContentSeq" value="${bdto.boardContentSeq}" />
        <input type="hidden" name="crewSeq" value="${bdto.crewSeq}" />
        ...
        <div>
            ...
            <textarea name="content"
                      ...
                      required>${bdto.content}</textarea>
        </div>
        ...
        <div class="space-y-3">
            ...
            <c:if test="${not empty bdto.attach}">
                <div class="bg-gray-50 rounded-xl p-4 border border-gray-200 flex items-center justify-between">
                    <div class="text-gray-700">
                        📎 현재 첨부:
                        <a href="${pageContext.request.contextPath}/crewboardFile/${bdto.attach}"
                           target="_blank"
                           class="underline text-blue-600 hover:text-blue-800">${bdto.attach}</a>
                    </div>
        ...
        <div class="flex justify-end gap-3 pt-4 border-t border-gray-200">
            <button type="button"
                    onclick="location.href='${pageContext.request.contextPath}/crewboard/view?boardContentSeq=${bdto.boardContentSeq}'"
